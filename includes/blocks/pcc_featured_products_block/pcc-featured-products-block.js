(function(blocks, editor, components, i18n, element) {
  ...
  registerBlockType("wpexpertplugins/pcc-featured-products", {
    title: i18n.__("Featured Products Shortcode"),
    description: i18n.__("Featured Products Shortcode"),
    icon: iconEl,
    category: "common",
    attributes: {
    ...
    edit: function(props) {
      ...
      var localize_cats = pcc_featured_products_block_localize.pcc_categories,
        cat_options = [];
      ...
      return [
        ...
        el(
          ...
          el(
            ...
            {
              title: i18n.__("Featured Products shortcode settings"),
              className: "pcc-featured-products-block-settings",
              initialOpen: true
            },
            // Select A Shortcode
            el(SelectControl, {
        ...
        el(ServerSideRender, {
          block: "wpexpertplugins/pcc-featured-products",
