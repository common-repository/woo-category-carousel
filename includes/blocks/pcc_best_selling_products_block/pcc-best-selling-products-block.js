(function(blocks, editor, components, i18n, element) {
  ...
  registerBlockType("wpexpertplugins/pcc-best-selling-products", {
    title: i18n.__("Best Selling Products Shortcode"),
    description: i18n.__("Best Selling Products Shortcode"),
    icon: iconEl,
    category: "common",
    attributes: {
    ...
    edit: function(props) {
      ...
      var localize_cats =
          pcc_best_selling_products_block_localize.pcc_categories,
        cat_options = [];
      ...
      return [
        ...
        el(
          ...
          el(
            ...
            {
              title: i18n.__("Best Selling Products shortcode settings"),
              className: "pcc-bsp-block-settings",
              initialOpen: true
            },
            // Select A Shortcode
            el(SelectControl, {
        ...
        el(ServerSideRender, {
          block: "wpexpertplugins/pcc-best-selling-products",
