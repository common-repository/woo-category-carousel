<div class="wrap">
    <h1><?php echo esc_html__("Best Selling Products Shortcode Generator", "product-cat-carousel"); ?></h1>

    <table class="form-table">
        <tbody>
            <tr>
                <th scope="row"><label for="shortcode"><?php echo esc_html__("Copy Shortocde", "product-cat-carousel"); ?></label></th>
                <td><input type="text" id="shortcode" value="[pcc_bestselling_products_slider]" readonly class="large-text"></td>
            </tr>
            <tr>
    ...
    <p class="submit">
        <input type="button" name="bsp_submit" id="bsp_submit" class="button button-primary" value="<?php echo esc_html__("Generate Shortcode", "product-cat-carousel"); ?>">
